...
class RealTimeXianStock
  ...
  def pa_wang_ye
    ...
    # options.binary = "/home/fen/Documents/script_for_stock/chromedriver" 
  ...
  def xin_zi_yuan
    ...
    data = @yahoo_client.quotes(@stock_abb_array, [:last_trade_date, :last_trade_price, :change_in_percent])
    data.each { |e|
      puts e.change_in_percent, e.symbol
    }
  end
...
RealTimeXianStock.new(0.2).pa_wang_ye
